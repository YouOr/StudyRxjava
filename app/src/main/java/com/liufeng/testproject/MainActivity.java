...
import com.liufeng.testproject.callback.PermissionListener;
import com.liufeng.testproject.http.Fault;
import com.liufeng.testproject.util.BitmapUtil;
        ...
        if (requestCode == REQUEST_CODE_CHOOSE && resultCode == RESULT_OK) {
            ...
            try {
                for (Uri uri : mSelected) {
                    ...
                    userLoader.upImage("AddImageInfo", "Test_" + dateFormat.format(date) + ".jpg", "2018-06-07", "1", "1", "1", "1", "1", BitmapUtil.Bitmap2StrByBase64(BitmapFactory.decodeFile(getFileAbsolutePath(MainActivity.this, uri))))
                    ...
                    //                Toast.makeText(MainActivity.this, BitmapUtil.Bitmap2StrByBase64(BitmapFactory.decodeFile(getFileAbsolutePath(MainActivity.this, uri))).substring(0,555), Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
                e.printStackTrace();
